# image_rotatoy.py
'''
from PIL import Image # importa el modulo image de la libreria pil

#carga una imagen llamada 'tripleten_logo.jpeg'.
im=Image.open('tripleten_logo.jpeg')

# obten el tamaño de la imagen mediante el atributo .size y muestralo
print(im.size)

# gira la imagen 90 grados en sentido contrario a la sagujas del reloj

rotated = im.rotate(90)
                    
# guarda la imagen girada
rotated.save('totated.png')
'''
# image_rotator.py
